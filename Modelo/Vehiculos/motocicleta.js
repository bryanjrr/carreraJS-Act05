...
export class Motocicleta extends Vehiculo {
    ...
    controlSuelo(pista) {
        ...
        if (pista instanceof Circuito) {
            if (pista.tiempo === "lluvioso" && this.traccion === "dura") {
                caerProbabilidad = 30;
            } else if (pista.tiempo === "húmedo" && this.traccion === "dura") {
                caerProbabilidad = 20;
            } else if (pista.tiempo === "mojado" && this.traccion === "dura") {
                caerProbabilidad = 30;
            } else if (pista.tiempo === "mojado" && this.traccion === "mediana") {
                caerProbabilidad = 20;
            } else if (pista.tiempo === "húmedo" && this.traccion === "mediana") {
                caerProbabilidad = 10;
            } else {
                caerProbabilidad = 5;
            }
